        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedCallId = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Calls_RelatedCallId",
                        column: x => x.RelatedCallId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByAgentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Calls_RelatedCallId",
                        column: x => x.RelatedCallId,
                        principalTable: "Calls",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2026, 1, 25, 9, 34, 1, 594, DateTimeKind.Utc).AddTicks(1066), "admin@example.com", "Admin", true, null, "User", "AQAAAAEAACcQAAAAEKqgkTvtFvqrG4Z7h5x5m5B5x5m5B5x5m5B5x5m5B5x5m5B5x5m5B5x5", "0000000000", 3, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_RelatedCallId",
                table: "Orders",
                column: "RelatedCallId");
